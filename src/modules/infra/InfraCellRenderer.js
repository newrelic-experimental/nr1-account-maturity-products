...
export const InfraCellRenderer = function(rowData, popupColHeaders) {
  ...
  function NumberCellRender(row, popupColHeaders) {
    ...
    return renderPopup(row, popupColHeaders, bar)
  }

  function renderPopup(row, popupColHeaders, trigger) {
    const contentStyle = {
      maxWidth: '1500x',
      width: '90%'
    };
