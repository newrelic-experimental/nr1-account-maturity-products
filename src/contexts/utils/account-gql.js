...
export const FETCH_ACCOUNT_WITH_ID_GQL_OBJ = {
  ...
  fragment ERRORS_INBOX_Fragments on Actor {
    errorsInbox {
      totalErrorGroups: errorGroups(filter: {
        accountIds: [$id],
        assignment: {}}) {
        totalCount
        results {
      ...
      totalAssignErrorGroups: errorGroups(filter: {accountIds: [$id], assignment: {}, isAssigned: true}) {
        totalCount
      }
    }
